            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('parents.index')" :active="route().current('parents.index')">
                            Parents
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink :href="route('assignments.index')" :active="route().current('assignments.index')">
                            Assignments
                        </ResponsiveNavLink>
